...
class DeviceRecordViewModel extends ViewModel {
    ...
    public $viewFields = array(
        ...
        'O_record'=>array('client_ID','book_info','style','type','source','g_id','pay_mode','price'=>'o_price','deposit','phone','status'=>'o_status','cTime'=>'o_cTime', '_on'=>'D_record.o_id=O_record.o_id','_table'=>"o_record"),
